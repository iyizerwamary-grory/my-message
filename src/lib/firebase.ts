...
// A function to check if the config is not using placeholder values
export const isFirebaseConfigured = firebaseConfig && firebaseConfig.apiKey && firebaseConfig.projectId && firebaseConfig.projectId !== "";
